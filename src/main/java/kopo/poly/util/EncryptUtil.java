...
public class EncryptUtil {
    ...
    //초기 벡터(16바이트 크기를 가지며, 16바이트 단위로 암호화시, 암호화할 총 길이가 16바이트가 되지 못하면 뒤에 ㅜ가하는 바이트)
    final static byte[] ivBytes = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    public static String encHashSHA256(String str) throws Exception {
        ...
        try {
            ...
            // 자바는 기본적으로 표준 암호화 알고리즘을 java.security 패키지를 통해 제공
            ...
            // 자바에서 제공하지 않은 알고리즘이 아닌 경우, 에러 발생
         ...
         * AES128 CBC 암호화 함수
         *
         * 128은 암호화 키 길이를 의미 128비트는 = 16바이트(1바이트=8비트 * 16 = 128)
         */
        public static String encAES128CBC (String str)
                throws UnsupportedOperationException, NoSuchAlgorithmException, NoSuchPaddingException,
